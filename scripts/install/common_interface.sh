...
py_version_check(){
    local pyver_set="3.7 3.8 3.9 3.10 3.11 3.12 3.13 3.14"
    ...
    if [ $? -eq 0 ]; then
        ...
        if [ "x$python3_version" != "x" ]; then
            ...
            echo "[Common] [$cur_date] [WARNING]: $python_version is not in Python3.7.x, Python3.8.x, Python3.9.x, Python3.10.x, Python3.11.x, Python3.12.x, Python3.13.x, Python3.14.x."
            return 1
        else
