...
if(CPACK_ENABLE_DEVICE)
    ...
    file(REMOVE "${DEB_DELIVERY}/device-${CPACK_CANN_INSTALL_COMPONENT}.tar.gz")
endif()

if(CPACK_CANN_PRE_PKG_${CPACK_CANN_INSTALL_COMPONENT})
    include(${CPACK_CANN_PRE_PKG_${CPACK_CANN_INSTALL_COMPONENT}})
endif()
