...
function(do_get_pkg_dependencies pkgs all_pkgs)
    ...
    foreach(pkg IN LISTS pkgs)
        ...
        set(pkg_version_path "${CANN_TOP_DIR}/${pkg_dir}/version.cmake")
        if(NOT EXISTS "${pkg_version_path}")
            message(FATAL_ERROR "Could not find package ${pkg} version.cmake ${pkg_version_path}")
        endif()
        include(${pkg_version_path})
