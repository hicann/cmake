...
if(rdma_core_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    if(EXISTS "${CANN_3RD_LIB_PATH}/rdma-core/CMakeLists.txt")
        ...
        message(STATUS "[ThirdParty][rdma-core] use local rdma-core cache ${RDMA_CORE_SRC_DIR}.")
    elseif(EXISTS "${CANN_3RD_LIB_PATH}/${RDMA_CORE_FILE}")
        set(RDMA_CORE_PROJECT_URL "${CANN_3RD_LIB_PATH}/${RDMA_CORE_FILE}")
        message(STATUS "[ThirdParty][rdma-core] use local rdma-core cache ${RDMA_CORE_PROJECT_URL}.")
    elseif(EXISTS "${CANN_3RD_LIB_PATH}/rdma-core/${RDMA_CORE_FILE}")
        ...
        message(STATUS "[ThirdParty][rdma-core] pipeline use rdma-core cache ${RDMA_CORE_PROJECT_URL}.")
    else()
        set(RDMA_CORE_PROJECT_URL "${RDMA_CORE_URL}")
        message(STATUS "[ThirdParty][rdma-core] not use cache, download rdma-core ${RDMA_CORE_URL}.")
    endif()
