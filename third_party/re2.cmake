...
if (EXISTS ${RE2_FILE})
    ...
    if(EXISTS ${REQ_URL})
        message(STATUS "[ThirdParty][re2] ${REQ_URL} found.")
    elseif(EXISTS ${REQ_URL_BACK})
        message(STATUS "[ThirdParty][re2] ${REQ_URL_BACK} found.")
        set(REQ_URL ${REQ_URL_BACK})
    else()
        message(STATUS "[ThirdParty][re2] ${REQ_URL} not found, need download.")
