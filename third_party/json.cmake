...
if(NOT json_FOUND OR FORCE_REBUILD_CANN_3RD)
    if(EXISTS "${CANN_3RD_LIB_PATH}/json-3.11.3.tar.gz")
        ...
        message(STATUS "[ThirdPartyLib][json] use local json cache.")
        set(REQ_URL ${CANN_3RD_LIB_PATH}/json-3.11.3.tar.gz)
    elseif(EXISTS "${CANN_3RD_LIB_PATH}/json/json-3.11.3.tar.gz")
        message(STATUS "[ThirdPartyLib][json] pipeline use json cache.")
        set(REQ_URL ${CANN_3RD_LIB_PATH}/json-3.11.3.tar.gz)
    else()
        message(STATUS "[ThirdPartyLib][json] not use cache, download json source.")
...
message(STATUS "[ThirdPartyLib][json] build json end, JSON_SOURCE_PATH: ${JSON_SOURCE_PATH}.")
if(NOT TARGET json)
    ...
    message(STATUS "[ThirdParty][json] json already exist.")
endif()