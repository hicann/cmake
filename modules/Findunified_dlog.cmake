...
find_path(_INCLUDE_DIR_DLOG_PUB
    NAMES dlog_pub.h
...
if(PRODUCT_SIDE STREQUAL "device")
    find_library(unified_dlog_SHARED_LIBRARY
        NAMES device/lib64/libunified_dlog.so
        PATH_SUFFIXES lib64
        NO_CMAKE_SYSTEM_PATH
        NO_CMAKE_FIND_ROOT_PATH)
else()
...
find_package_handle_standard_args(unified_dlog
    FOUND_VAR
        unified_dlog_FOUND
    REQUIRED_VARS
        _INCLUDE_DIR_DLOG_PUB
        unified_dlog_SHARED_LIBRARY
)

if(unified_dlog_FOUND)
    set(unified_dlog_INCLUDE_DIR "${_INCLUDE_DIR_DLOG_PUB}")
