...
elseif(PRODUCT_SIDE STREQUAL "device")
    find_library(C_SEC_STATIC_LIBRARY NAMES libc_sec.a PATH_SUFFIXES lib64)
    find_library(C_SEC_SHARED_LIBRARY NAMES device/lib64/libc_sec.so PATH_SUFFIXES lib64)
else()
    find_library(C_SEC_STATIC_LIBRARY NAMES libc_sec.a PATH_SUFFIXES lib64)
    find_library(C_SEC_SHARED_LIBRARY NAMES libc_sec.so PATH_SUFFIXES lib64)
endif()
...
if(securec_FOUND)
    ...
    cmake_print_variables(C_SEC_STATIC_LIBRARY)
    ...
    cmake_print_properties(TARGETS c_sec_static
